...
const ExplorePage = () => {
    ...
    return (
        <main id="explore" className="relative min-h-screen overflow-hidden bg-black text-white" style={{ fontFamily: "'Inter', 'Space Grotesk', sans-serif" }}>
            ...
            <div className="absolute top-0 left-1/4 w-150 h-150 rounded-full opacity-[0.12] blur-[140px] pointer-events-none" style={{ background: '#C084FC' }} />
            <div className="absolute bottom-0 right-1/4 w-150 h-150 rounded-full opacity-[0.12] blur-[140px] pointer-events-none" style={{ background: '#E8FF47' }} />
            ...
            <div className="relative z-10 mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
                ...
                <div className="mt-24 grid gap-6 lg:grid-cols-2">
                    <div
                        className="explore-reveal rounded-4xl border border-white/10 p-8"
                        data-id="value1"
                        style={{
                ...
                <div
                    className="explore-reveal mt-20 flex flex-col items-center text-center rounded-4xl p-10 md:p-14"
                    data-id="cta"
                    style={{
